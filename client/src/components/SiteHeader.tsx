...
const markUrl = "/manus-storage/digitalsolutions-symbol-mark_3caa995c.png";
const categoryMenus = [
...
export default function SiteHeader() {
  ...
  return <>
    ...
    <header className="site-header"><div className="header-inner">
      <Link className="brand-lockup" href="/" aria-label="DigitalSolutions.cv home"><img src={markUrl} alt="" className="brand-mark" /><span>Digital<span>Solutions</span><i>.cv</i></span></Link>
